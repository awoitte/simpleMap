var fontAwesomeIcons =[
    {
        name: "New Icons",
        icons: ["fa-rub","fa-ruble","fa-rouble","fa-pagelines","fa-stack-exchange","fa-arrow-circle-o-right","fa-arrow-circle-o-left","fa-caret-square-o-left","fa-toggle-left","fa-dot-circle-o","fa-wheelchair","fa-vimeo-square","fa-try","fa-turkish-lira","fa-plus-square-o"]
